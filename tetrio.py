"""Runtime controller for playing TETR.IO.

This module contains the ``TetrioBot`` class. It captures the game screen,
recognizes the board and pieces, asks the AI for the best move, and sends the
corresponding keyboard actions. Configuration and calibration remain in
``bot.py``.
"""
